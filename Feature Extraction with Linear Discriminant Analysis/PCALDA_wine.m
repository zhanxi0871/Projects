close all
% load data
winedata = csvread('winedata.csv')
species = importdata('wineclass.csv');
...
idx = (1:178)';
idx_train = datasample(idx,20,'Replace',false);
idx_test = setdiff(idx,idx_train);
irisdata_train = winedata(idx_train,:);
...
irisdata_test = winedata(idx_test,:);
